...
func Setup(t *testing.T) (*Controller, *clients.ClientSet, func()) {
	...
	controller := NewController("example.com", InitKey, namespace, TestServerPort, true, clientSet)
...
func NewRequest(t *testing.T, query map[string]string, body any, user *models.CreatedTeamAPIKey) *http.Request {
