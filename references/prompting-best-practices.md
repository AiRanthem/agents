> 逐字复制自 OpenAI Model guidance「Using GPT-6 Astra · Prompting best practices」，未改写；代际变化时用最新原文整体替换下方正文。来源：https://developers.openai.com/api/docs/guides/latest-model#prompting-best-practices
