...
You can use the commands below to build the images with [Dockerfiles](./dockerfiles).
...
1. Create a [SandboxSet](examples/code_interpreter/sandboxset.yaml) with name `code-interpreter` as an E2B template
   ```shell
